<%@ Page Title="VC3 Church - Admin" Language="C#" MasterPageFile="~/Presentation/main.master" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="Presentation_Admin_Default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="admin-menu-wrap" ng-controller="AdminController">
        <ul class="second-nav-header">
            ...
            <li class="panel3"><a href="#">Add Speaker</a></li>
        </ul>
    </div>
